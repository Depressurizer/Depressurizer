...
namespace Depressurizer {
    public partial class DlgAutoCatCreate : Form {
        ...
        public DlgAutoCatCreate( string name = null, AutoCatType type = AutoCatType.None ) {
            ...
            typeNames = new string[] { GlobalStrings.AutoCat_Name_Genre, GlobalStrings.AutoCat_Name_Flags, GlobalStrings.AutoCat_Name_Tags, GlobalStrings.AutoCat_Name_Year };
            types = new AutoCatType[] { AutoCatType.Genre, AutoCatType.Flags, AutoCatType.Tags, AutoCatType.Year };
