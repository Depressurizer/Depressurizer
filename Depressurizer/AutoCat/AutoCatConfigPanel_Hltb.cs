...
namespace Depressurizer.AutoCat
{
    public partial class AutoCatConfigPanel_Hltb : AutoCatConfigPanel
    {
        ...
        private readonly BindingList<HltbRule> ruleList = new BindingList<HltbRule>();
        ...
        public AutoCatConfigPanel_Hltb()
        {
            ...
            //initialize combobox
            cmbTimeType.Items.AddRange(new object[] {TimeType.Main, TimeType.Extras, TimeType.Completionist});
