...
namespace Depressurizer
{
    public partial class AutoCatConfigPanel_DevPub : AutoCatConfigPanel
    {
        ...
        public void FillDevList(ICollection<string> preChecked = null)
        {
            ...
            IEnumerable<Tuple<string, int>> devList = Database.Instance.CalculateSortedDevList(chkOwnedOnly.Checked ? ownedGames : null, (int) list_numScore.Value);
        ...
        {
            Cursor = Cursors.WaitCursor;
            IEnumerable<Tuple<string, int>> pubList = Database.Instance.CalculateSortedPubList(chkOwnedOnly.Checked ? ownedGames : null, (int) list_numScore.Value);
