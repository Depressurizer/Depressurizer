...
namespace Depressurizer
{
    public partial class AutoCatConfigPanel_Tags : AutoCatConfigPanel
    {
        ...
        public void FillTagsList(ICollection<string> preChecked = null)
        {
            ...
            IEnumerable<Tuple<string, float>> tagList = Database.Instance.CalculateSortedTagList(list_chkOwnedOnly.Checked ? ownedGames : null, (float) list_numWeightFactor.Value, (int) list_numMinScore.Value, (int) list_numTagsPerGame.Value, list_chkExcludeGenres.Checked, false);
