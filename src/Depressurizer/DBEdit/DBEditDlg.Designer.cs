...
namespace Depressurizer {
    partial class DBEditDlg {
        ...
        private void InitializeComponent() {
			...
			this.chkTypeSoftware = new System.Windows.Forms.CheckBox();
			...
			this.grpTypes.Controls.Add(this.chkTypeSoftware);
			...
			// chkTypeSoftware
			// 
			resources.ApplyResources(this.chkTypeSoftware, "chkTypeSoftware");
			this.chkTypeSoftware.Name = "chkTypeSoftware";
			this.chkTypeSoftware.UseVisualStyleBackColor = true;
			this.chkTypeSoftware.CheckedChanged += new System.EventHandler(this.chkType_CheckedChanged);
			// 
			// DBEditDlg
			// 
		...
		private System.Windows.Forms.CheckBox chkTypeSoftware;
	}
}
